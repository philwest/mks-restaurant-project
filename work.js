    ...
    */
        ...
        */
        ...
        var populatePieces = function(json) {
            ...
            //         menuItemElement = menuItemElement+ '<div class="menu-item-name">' + json[x].dish + '</div>'; 
            //         menuItemElement = menuItemElement+ '<p class="menu-item-description">' + json[x].ingredients + '<div>';
            //         menuItemElement = menuItemElement+ '<div class="menu-item-price">' + json[x].price + '<div>';
            //     } else {
            //         menuItemElement = menuItemElement+ '<div class="menu-item-name">' + json[x].dish + '</div>'; 
            //         menuItemElement = menuItemElement+ '<div class="menu-item-price">' + json[x].price + '<div>';
            // }
        ...
        */
        ...
        var populateSections = function(json) {
            ...
            */
            ...
            // for (var x = 0; x < json.length; x++) {
            //     if (json[x].section) {
            //         menuSectionElement = menuSectionElement+ '<div id="menu-section-content" class="menu-section-content menu-' + DINNER BUTTON GOES HERE + '-is-active">'
            //         '<div class="menu-group columns small-12 medium-4"><h4>' + json[x].section + '</h4>' +  '</div>' + '</div>'    
            // }

            //     return menugroupmaker;
            // }
        ...
        */
        $.getJSON("http://mksrestaurantapi.herokuapp.com/menu-dinner.json"), function(data) {
